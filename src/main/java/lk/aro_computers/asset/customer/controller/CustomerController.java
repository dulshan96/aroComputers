package lk.aro_computers.asset.customer.controller;
...
import lk.aro_computers.util.service.TwilioMessageService;
...
//if customer has id that customer is not a new customer
        if (customer.getId() == null) {
            ...
            if (customer.getEmail() != null) {
                emailService.sendEmail(customer.getEmail(), "Welcome Message", "Welcome to ARO Computers...");
            }
            if (customer.getMobile() != null) {
            //    twilioMessageService.sendSMS(customer.getMobile(), "Welcome to ARO Computers");
            }
        }
